...
public class JsfUtils {
    ...
    * Method for taking a reference to a JSF binding expression and returning
    ...
    public static Object getExpressionValue(String name) { 
...
*/
  ...
  /**
   * Set an HTTP Sesssion attribute.
   * @param name attribute name
   * @param value attribute value
   */
  public static void setSessionAttribute(String name, Object value) {
      getFacesContext().getExternalContext().getSessionMap().put(name,
                                                                 value);
  }
    /*
...
*/
    ...
    public static void addMessage(UIComponent component, FacesMessage.Severity type,
                           String message) {
